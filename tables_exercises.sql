...
# What is the relationship between the employees and the departments tables? It is a one to many relationship because MySQL connects the elements of tables to each others in an almost infinite entanglement of links
